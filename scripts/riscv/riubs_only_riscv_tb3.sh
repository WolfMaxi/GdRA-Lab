...
ghdl -a --std=08 --workdir="${workdir}vhdl" "${workdir}testbenches/riscv/riubs_only_RISC_V_tb3.vhdl"
ghdl -e --std=08 --workdir="${workdir}vhdl" riubs_only_RISC_V_tb3
ghdl -r --std=08 --workdir="${workdir}vhdl" riubs_only_RISC_V_tb3 --wave="${workdir}vhdl/vcd/riubs_bp_only_riscv.ghw" --vcd="${workdir}vhdl/vcd/riubs_bp_only_riscv.vcd"