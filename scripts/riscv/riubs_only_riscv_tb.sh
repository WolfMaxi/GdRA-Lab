...
# ===================================
ghdl -a --std=08 --workdir="${workdir}vhdl" "${workdir}riscv/riubs_only_RISC_V.vhdl"
ghdl -a --std=08 --workdir="${workdir}vhdl" "${workdir}testbenches/riscv/riubs_only_RISC_V_tb.vhdl"
ghdl -e --std=08 --workdir="${workdir}vhdl" riubs_only_RISC_V_tb
ghdl -r --std=08 --workdir="${workdir}vhdl" riubs_only_RISC_V_tb --wave="${workdir}vhdl/vcd/riubs-only_riscv.ghw" --vcd="${workdir}vhdl/vcd/riubs-only_riscv.vcd"