...
ghdl -a --std=08 --workdir="${workdir}vhdl" "${workdir}testbenches/riscv/riub_only_RISC_V_tb2.vhdl"
ghdl -e --std=08 --workdir="${workdir}vhdl" riub_only_RISC_V_tb2
ghdl -r --std=08 --workdir="${workdir}vhdl" riub_only_RISC_V_tb2 --wave="${workdir}vhdl/vcd/riub-only_riscv2.ghw" --vcd="${workdir}vhdl/vcd/riub-only_riscv2.vcd"