...
ghdl -a --std=08 --workdir="${workdir}vhdl" "${workdir}testbenches/alu/my_alu_b_tb.vhdl"
ghdl -e --std=08 --workdir="${workdir}vhdl" my_alu_b_tb
ghdl -r --std=08 --workdir="${workdir}vhdl" my_alu_b_tb --vcd="${workdir}vhdl/vcd/my_alu_b_tb.vcd"
