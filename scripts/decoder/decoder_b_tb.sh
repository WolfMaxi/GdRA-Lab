...
ghdl -a --std=08 --workdir="${workdir}vhdl" "${workdir}testbenches/decoder/decoder_b_tb.vhdl"
ghdl -e --std=08 --workdir="${workdir}vhdl" decoder_b_tb 
ghdl -r --std=08 --workdir="${workdir}vhdl" decoder_b_tb --vcd="${workdir}vhdl/vcd/decoder_b_tb.vcd"
