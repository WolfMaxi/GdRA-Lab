...
ghdl -a --std=08 --workdir="${workdir}vhdl" "${workdir}testbenches/decoder/decoder_s_tb.vhdl"
ghdl -e --std=08 --workdir="${workdir}vhdl" decoder_s_tb 
ghdl -r --std=08 --workdir="${workdir}vhdl" decoder_s_tb --vcd="${workdir}vhdl/vcd/decoder_s_tb.vcd"
